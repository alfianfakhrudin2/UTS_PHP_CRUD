...
if (isset($_POST['hapus'])) {
	$script2 = "DELETE FROM fakhrudin WHERE id_pembelian = $id_pembelian";
	...
	<div class="wrapper" style="margin-top: 60px;">
		<div class="row">
			...
			<div class="col-4">
				...
				<div class="box-detail-produk">
					<h2>Tentang pembeli</h2>
					<h4>Nama Pembeli : <?= $data['nama'] ?></h4>
					<h5>Alamat : <?= $data['alamat'] ?></h5>
					<p>Nomer pembeli: <?= $data['hp'] ?></p>
				</div>
				<div class="box-detail-produk">
					<h2>Tentang Transaksi</h2>
